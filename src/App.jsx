      ...
      <header className="sticky top-0 z-50 bg-[#0A0A0A]/80 backdrop-blur border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-md bg-gradient-to-br from-[#00FF84] to-teal-400" />
          ...
          <button className="text-sm font-semibold bg-[#00FF84] text-black px-3 py-1.5 rounded-lg">Sign In</button>
        </div>
      </header>
